...
def run_pipeline(
    ...
    from report_generator import determine_outbreak_model
    ...
    def _get_district_reasoning(district: str):
        ...
        model_key, _ = determine_outbreak_model(snapshot, d_risk.sub_scores, simulation_params)
    ...
    # 5. Report Generator
    reports = rg.generate_all_reports(overall_risk_result, snapshots, reasoning_map, simulation_params=simulation_params)
