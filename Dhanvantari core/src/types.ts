...
export interface IncidentReportJson {
  ...
  clinical_intelligence: {
    ...
    relevant_disease?: string;
    outbreak_model_name?: string;
    clinical_syndromes?: string[];
    clinical_situation?: string;
  ...
  affected_population: number | string;
  hospital_infrastructure: {
    total_beds: number | string;
    icu_occupancy: number | string;
  };
